...
# =============================================================================
        ...
        st.header("**Sentiment analysis with NLTK**")
...
# =============================================================================
        ...
        #print(str(positive.shape[0]/(df_new.shape[0])*100)+"% of positive tweets")
        print("Percentage of positive tweets are {:0.2f}.".format(positive.shape[0]/(df_new.shape[0])*100))
        pos = positive.shape[0]/df_new.shape[0]*100
        
        negative = df_new[df_new['Textblob PolarityResult sentiment']=="negative"]
        #print(str(negative.shape[0]/(df_new.shape[0])*100)+"% of negative tweets")
        print("Percentage of negative tweets are {:0.2f}.".format(negative.shape[0]/(df_new.shape[0])*100))
        neg = negative.shape[0]/df_new.shape[0]*100
        
        neutral = df_new[df_new['Textblob PolarityResult sentiment']=="neutral"]
        #print(str(neutral.shape[0]/(df_new.shape[0])*100)+"% of neutral tweets")
        print("Percentage of neutral tweets are {:0.2f}.".format(neutral.shape[0]/(df_new.shape[0])*100))
...
# =============================================================================
        ...
        print("Percentage of Objective tweets are {:0.2f}.".format(Objective.shape[0]/(df_new.shape[0])*100))
        ...
        print("Percentage of Subjective tweets are {:0.2f}.".format(Subjective.shape[0]/(df_new.shape[0])*100))
        ...
        print("Percentage of Very_Objective tweets are {:0.2f}.".format(Very_Objective.shape[0]/(df_new.shape[0])*100))
        ...
        print("Percentage of Very_Subjective tweets are {:0.2f}.".format(Very_Subjective.shape[0]/(df_new.shape[0])*100))
...
# =============================================================================
        ...
        print("Percentage of angry tweets are {:0.2f}.".format(angry.shape[0]/(df_new.shape[0])*100))
        ...
        print("Percentage of fear tweets are {:0.2f}.".format(fear.shape[0]/(df_new.shape[0])*100))
        ...
        print("Percentage of happy tweets are {:0.2f}.".format(happy.shape[0]/(df_new.shape[0])*100))
        ...
        print("Percentage of sad tweets are {:0.2f}.".format(sad.shape[0]/(df_new.shape[0])*100))
        ...
        print("Percentage of surprise tweets are {:0.2f}.".format(surprise.shape[0]/(df_new.shape[0])*100))
